...
public class Payment_ExamListAdapter extends RecyclerView.Adapter<Payment_ExamListAdapter.ViewClass> {
    Context context;
    String[] exam_status;
    String[] name;
    String[] author;
    //for onClick from java class (Second ....)
    private static Payment_ExamListAdapter.ClickListener clickListener;
    private TextView examname;
    private TextView authorname;

    public Payment_ExamListAdapter(Context context, String[] name, String[] exam_status, String[] author) {
    ...
    @NonNull
    @Override
    public Payment_ExamListAdapter.ViewClass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.payment_examlistadapter, null);

        return new Payment_ExamListAdapter.ViewClass(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Payment_ExamListAdapter.ViewClass viewClass, int i) {
...
//            author = itemView.findViewById(R.id.author_name);
    ...
    public void setOnItemClickListener(Payment_ExamListAdapter.ClickListener clickListener) {
        Payment_ExamListAdapter.clickListener = clickListener;
    }
