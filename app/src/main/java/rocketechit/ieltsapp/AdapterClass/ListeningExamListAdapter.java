...
public class ListeningExamListAdapter extends RecyclerView.Adapter<ListeningExamListAdapter.ViewClass> {
    Context context;
    String[] exam_status;
    String[] name;
    String[] author;
    //for onClick from java class (Second ....)
    private static ListeningExamListAdapter.ClickListener clickListener;
    private TextView examname;
    private TextView authorname;

    public ListeningExamListAdapter(Context context, String[] name, String[] exam_status, String[] author) {
    ...
    @NonNull
    @Override
    public ListeningExamListAdapter.ViewClass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.listening_exam_item_view, null);

        return new ListeningExamListAdapter.ViewClass(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListeningExamListAdapter.ViewClass viewClass, int i) {
...
//            author = itemView.findViewById(R.id.author_name);
    ...
    public void setOnItemClickListener(ListeningExamListAdapter.ClickListener clickListener) {
        ListeningExamListAdapter.clickListener = clickListener;
    }
