...
public class SpeakingExamListAdapter extends RecyclerView.Adapter<SpeakingExamListAdapter.ViewClass> {
    Context context;
    String[] exam_status;
    String[] name;
    String[] author;
    //for onClick from java class (Second ....)
    private static SpeakingExamListAdapter.ClickListener clickListener;
    private TextView examname;
    private TextView authorname;

    public SpeakingExamListAdapter(Context context, String[] name, String[] exam_status, String[] author) {
    ...
    @NonNull
    @Override
    public SpeakingExamListAdapter.ViewClass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.speaking_exam_list_adapter, null);

        return new SpeakingExamListAdapter.ViewClass(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SpeakingExamListAdapter.ViewClass viewClass, int i) {
...
//            author = itemView.findViewById(R.id.author_name);
    ...
    public void setOnItemClickListener(SpeakingExamListAdapter.ClickListener clickListener) {
        SpeakingExamListAdapter.clickListener = clickListener;
    }
